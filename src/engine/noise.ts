...
/** Seeded 2D simplex noise with fractal helpers. Output of `noise` is roughly in [-1, 1]. */
export class Noise2D {
  ...
  /** Ridged multifractal in [0, 1]; high values form long ridges (mountain ranges, ley lines). */
